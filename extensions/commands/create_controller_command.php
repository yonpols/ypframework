<?php
    class CreateControllerCommand extends YPFCommand {
        public function getDescription() {
            return 'creates a controller skeleton and optionally restful actions';
        }

        public function help($parameters) {
            echo "ypf create.controller controller-name [-rest <model-name>]\n".
                 "Creates a controller for the application using the passed parameters\n".
